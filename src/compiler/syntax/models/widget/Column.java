...
public class Column extends Widget {
    ...
    public Column(Width width, Height height, Margin margin, Padding padding, MainAxisAlignmentAttr mainAxisAlignmentAttr, CrossAxisAlignmentAttr crossAxisAlignmentAttr, Children children) {
